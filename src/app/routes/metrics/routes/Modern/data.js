    ...
    tasks: [
      {
        ...
        title: ['Agent ', <span className="jr-link">Kily Johns</span>, ' has added 7 new photos to the property ',
          <span className="jr-link">Albama’s House</span>],
        avatar: '',
        imageList: [require('assets/images/userAvatar/john-smith.png'), require('assets/images/userAvatar/john-smith.png'), require('assets/images/userAvatar/john-smith.png')],
      },
      {
        id: 6,
        name: 'Tom Moody',
