    ...
    <CardLayout styleName="col-lg-6">
      <div className="card-header">
        <div className="user-profile d-flex flex-row align-items-center">
          <Avatar
            alt="..."
            src={require("assets/images/userAvatar/jimmy-jo.jpg")}
      ...
      <img className="img-fluid" src={require("assets/images/cards/contemplative-reptile.jpeg")} alt="Card image cap"/>
