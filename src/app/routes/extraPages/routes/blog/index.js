      ...
      <div className="row">
        <div className="col-md-8 col-sm-7 col-12 animation slideInLeft">
          <div className="card shadow border-0 text-muted">
            <img className="card-img-top" src={require("assets/images/blog/article-post.jpeg")} alt="post"/>
          ...
          <div className="card shadow border-0 text-muted">
            <img className="card-img-top" src={require("assets/images/blog/carpanter.jpeg")} alt="post"/>
          ...
          <div className="card shadow border-0 text-muted">
            <img className="card-img-top" src={require("assets/images/blog/blog-image-3.jpeg")} alt="post"/>
              ...
              <ul className="articles-section list-unstyled">
                <li className="articles">
                  <span className="article-image jr-link">
                    <img src={require("assets/images/blog/desserts.jpeg")} alt="Articales Post"/>
                  </span>
                ...
                <li className="articles">
                  <span className="article-image jr-link">
                    <img src={require("assets/images/blog/article-post.jpeg")} alt="Articales Post"/>
                  </span>
                ...
                <li className="articles">
                  <span className="article-image jr-link">
                    <img src={require("assets/images/blog/article-post-1.jpeg")} alt="Articales Post"/>
                  </span>
