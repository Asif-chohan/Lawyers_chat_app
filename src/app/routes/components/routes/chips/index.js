  ...
  return (
    <div className="animated slideInUpTiny animation-duration-3">
      ...
      <div className="row mb-md-3">
        ...
        >
          <Chip avatar={<Avatar src={require("assets/images/userAvatar/alex-dolgove.png")}/>} label="Image Avatar"/>
        </CardBox>
        <CardBox
          styleName="col-lg-3 col-md-4 col-sm-6 col-12"
          cardStyle="text-center"
          ...
          <Chip
            avatar={<Avatar src={require("assets/images/userAvatar/domnic-harris.jpg")}/>}
