...
function InsetAvatarDividers() {
  return (
    <List>
      <ListItem button>
        <Avatar className="size-50" alt="Remy Sharp" src={require("assets/images/userAvatar/domnic-harris.jpg")}/>
      ...
      <Divider inset/>
      <ListItem button>
        <Avatar className="size-50" alt="Adelle Charles" src={require("assets/images/userAvatar/man-3.jpg")}/>
      ...
      <Divider inset/>
      <ListItem button>
        <Avatar className="size-50" alt="Remy Sharp" src={require("assets/images/userAvatar/stella-johnson.png")}/>
